package com.fms.admin.order.controller;
...
import com.fms.admin.order.service.AdminOrderService;
...
public class AdminOrderController {
	...
	public void orderExcelExport(HttpServletResponse response , @RequestParam Map<String, String> dateMap) throws Exception {
		...
		for (OrderDto orderDto :  adminOrderService.listNewOrder()) {
	        ...
	        cell = row.createCell(6);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue(orderDto.getProductsName());
	        cell = row.createCell(7);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue(orderDto.getOrderProductsQty());
	        cell = row.createCell(8);
	        cell.setCellStyle(bodyStyle);
